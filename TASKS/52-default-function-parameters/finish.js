 ...
 *
 * 1. Создайте функцию "weatherForecastDefault" с двумя параметрами "city" и "weather"
 *
...
const weatherForecast = (city, weather) =>{
    return `Прогноз погоды для города ${city}: ${weather ? weather : `Отличная погода!`}`
}

const weatherForecastDefault = (city, weather = "Отличная погода!") =>{
...
console.log(weatherForecastDefault('Dubai', 'Солнечно'))
// Прогноз погоды для города Dubai: Солнечно

console.log(weatherForecastDefault('London', 'Небольшой дождь'))
// Прогноз погоды для города London: Небольшой дождь

console.log(weatherForecastDefault('Paris'))
// Прогноз погоды для города Paris: Отличная погода!

console.log(weatherForecastDefault('Miami', ''))
// Прогноз погоды для города Miami:

console.log(weatherForecastDefault('Las Vegas', undefined))
// Прогноз погоды для города Las Vegas: Отличная погода!
